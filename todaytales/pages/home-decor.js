...
import { getAllPostsForHomeDecor } from '../lib/api'
  ...
  return (
    <div>
      <Head>
        ...
        <link rel="canonical" href='https://talestoday.com/home-decor'/>
...
export async function getStaticProps({ preview = false }) {
  const allPosts = (await getAllPostsForHomeDecor(preview)) || []
  return {
    props: { allPosts },
  }
}
